package com.mjutarzan.tarzan.global.oauth2.service;
...
import com.mjutarzan.tarzan.global.oauth2.OAuthAttributes;
...
//        }
    ...
    private User getUser(OAuthAttributes attributes, SocialType socialType) {
        log.info("getUser입니당!");
        log.info( attributes.getOauth2UserInfo().getId());
        log.info(socialType+"");
