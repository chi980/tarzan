...
export const scaleRatios: Record<number, ScaleRatio> = {
  ...
  0: { distance: 10, scale: 950 },
  1: { distance: 20, scale: 1900 },
  2: { distance: 30, scale: 3800 },
  3: { distance: 50, scale: 7600 },
  4: { distance: 100, scale: 15200 },
  5: { distance: 250, scale: 30400 },
  6: { distance: 500, scale: 60800 },
