  ...
  <form class="input-form" @submit.prevent="submitForm">
    <div class="input-group" id="장점">
      ...
      <textarea
        ...
        v-model="reviewData.review_advantage" />

      <TagButtonGroup
        v-model:selectedButtons="reviewData.review_advantage_tags"
    ...
    <div class="input-group" id="단점">
      ...
      <textarea
        ...
        type="text"
        placeholder="내용를 입력해주세요."
        v-model="reviewData.review_disadvantage" />
      <TagButtonGroup
        v-model:selectedButtons="reviewData.review_disadvantage_tags"
